...
.. code:: haskell
    ...
    -- file: ch17/PCRECompile0.hs
    type PCRE = ()

[译注：原文代码文件名为 PCRE-compile.hs，根据实际情况改为 PCRECompile0.hs]
...
[译注：bottom 类型参见第 26 章或者：http://www.haskell.org/haskellwiki/Bottom ]
...
.. code:: haskell
    ...
    -- file: ch17/PCRECompile.hs
    data Regex = Regex !(ForeignPtr PCRE)
                       !ByteString
            deriving (Eq, Ord, Show)

[译注：原文代码文件名为 PCRE-compile.hs，根据实际情况改为 PCRECompile.hs]
...
[译注：原文运行代码为 Regex.hs，根据实际情况改为 PCRECompile.hs]
